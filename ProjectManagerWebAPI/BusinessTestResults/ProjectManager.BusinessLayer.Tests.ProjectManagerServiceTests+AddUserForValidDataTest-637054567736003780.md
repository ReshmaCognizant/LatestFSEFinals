# ProjectManager.BusinessLayer.Tests.ProjectManagerServiceTests+AddUserForValidDataTest
...
```
NBench.NBenchException: Error occurred during $ProjectManager.BusinessLayer.Tests.ProjectManagerServiceTests+AddUserForValidDataTest RUN. ---> NUnit.Framework.AssertionException: Multiple failures or warnings in test:
  1)   Expected: True
  But was:  False
  ...
  But was:  False
   ...
   at ProjectManager.BusinessLayer.Tests.ProjectManagerServiceTests.AddUserForValidDataTest() in C:\Reshma\FinalCertification\LatestFSEFinals\ProjectManagerWebAPI\ProjectManager.BusinessLayer.Tests\ProjectManagerServiceTests.cs:line 89
