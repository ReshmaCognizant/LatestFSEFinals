# ProjectManager.DataLayer.Tests.ProjectManagerRepositoryTests+GetUserTestForValidDataTest
...
```
NBench.NBenchException: Error occurred during $ProjectManager.DataLayer.Tests.ProjectManagerRepositoryTests+GetUserTestForValidDataTest RUN. ---> NUnit.Framework.AssertionException: Multiple failures or warnings in test:
  1)   Expected: True
  But was:  False
  ...
  But was:  null
   ...
   at ProjectManager.DataLayer.Tests.ProjectManagerRepositoryTests.GetUserTestForValidDataTest() in C:\Reshma\FinalCertification\LatestFSEFinals\ProjectManagerWebAPI\ProjectManager.DataLayer.Tests\ProjectManagerRepositoryTests.cs:line 263
