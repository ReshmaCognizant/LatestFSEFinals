# ProjectManager.DataLayer.Tests.ProjectManagerRepositoryTests+UpdateParentTaskForValidDataTest
_9/30/2019 3:59:55 PM_
### System Info
```ini
...
```
NBench.NBenchException: Error occurred during $ProjectManager.DataLayer.Tests.ProjectManagerRepositoryTests+UpdateParentTaskForValidDataTest RUN. ---> NUnit.Framework.AssertionException: Multiple failures or warnings in test:
  1)   Expected: True
  But was:  False
  ...
  But was:  False
   ...
   at ProjectManager.DataLayer.Tests.ProjectManagerRepositoryTests.UpdateParentTaskForValidDataTest() in C:\Reshma\FinalCertification\LatestFSEFinals\ProjectManagerWebAPI\ProjectManager.DataLayer.Tests\ProjectManagerRepositoryTests.cs:line 533
