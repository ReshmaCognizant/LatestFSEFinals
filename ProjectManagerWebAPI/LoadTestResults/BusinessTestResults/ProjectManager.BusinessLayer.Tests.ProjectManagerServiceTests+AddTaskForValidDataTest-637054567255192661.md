# ProjectManager.BusinessLayer.Tests.ProjectManagerServiceTests+AddTaskForValidDataTest
_9/30/2019 4:12:05 PM_
### System Info
```ini
...
```
NBench.NBenchException: Error occurred during $ProjectManager.BusinessLayer.Tests.ProjectManagerServiceTests+AddTaskForValidDataTest RUN. ---> NUnit.Framework.AssertionException:   Expected: True
  But was:  False
   ...
   at ProjectManager.BusinessLayer.Tests.ProjectManagerServiceTests.AddTaskForValidDataTest() in C:\Reshma\FinalCertification\LatestFSEFinals\ProjectManagerWebAPI\ProjectManager.BusinessLayer.Tests\ProjectManagerServiceTests.cs:line 38
