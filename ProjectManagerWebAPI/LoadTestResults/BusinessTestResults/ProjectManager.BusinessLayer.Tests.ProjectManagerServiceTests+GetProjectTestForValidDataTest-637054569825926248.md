# ProjectManager.BusinessLayer.Tests.ProjectManagerServiceTests+GetProjectTestForValidDataTest
...
```
NBench.NBenchException: Error occurred during $ProjectManager.BusinessLayer.Tests.ProjectManagerServiceTests+GetProjectTestForValidDataTest RUN. ---> NUnit.Framework.AssertionException: Multiple failures or warnings in test:
  1)   Expected: True
  But was:  False
  ...
  But was:  null
   ...
   at ProjectManager.BusinessLayer.Tests.ProjectManagerServiceTests.GetProjectTestForValidDataTest() in C:\Reshma\FinalCertification\LatestFSEFinals\ProjectManagerWebAPI\ProjectManager.BusinessLayer.Tests\ProjectManagerServiceTests.cs:line 295
