# ProjectManager.BusinessLayer.Tests.ProjectManagerServiceTests+UpdateUserForInValidDataTest
...
```
NBench.NBenchException: Error occurred during $ProjectManager.BusinessLayer.Tests.ProjectManagerServiceTests+UpdateUserForInValidDataTest RUN. ---> NUnit.Framework.AssertionException: Multiple failures or warnings in test:
  1)   Expected: True
  But was:  False
  ...
  But was:  True
   ...
   at ProjectManager.BusinessLayer.Tests.ProjectManagerServiceTests.UpdateUserForInValidDataTest() in C:\Reshma\FinalCertification\LatestFSEFinals\ProjectManagerWebAPI\ProjectManager.BusinessLayer.Tests\ProjectManagerServiceTests.cs:line 467
