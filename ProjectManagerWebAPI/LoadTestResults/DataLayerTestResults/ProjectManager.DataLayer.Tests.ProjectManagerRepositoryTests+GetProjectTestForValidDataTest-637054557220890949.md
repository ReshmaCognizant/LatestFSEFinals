# ProjectManager.DataLayer.Tests.ProjectManagerRepositoryTests+GetProjectTestForValidDataTest
_9/30/2019 3:55:22 PM_
### System Info
```ini
...
```
NBench.NBenchException: Error occurred during $ProjectManager.DataLayer.Tests.ProjectManagerRepositoryTests+GetProjectTestForValidDataTest RUN. ---> NUnit.Framework.AssertionException: Multiple failures or warnings in test:
  1)   Expected: True
  But was:  False
  ...
  But was:  null
   ...
   at ProjectManager.DataLayer.Tests.ProjectManagerRepositoryTests.GetProjectTestForValidDataTest() in C:\Reshma\FinalCertification\LatestFSEFinals\ProjectManagerWebAPI\ProjectManager.DataLayer.Tests\ProjectManagerRepositoryTests.cs:line 285
