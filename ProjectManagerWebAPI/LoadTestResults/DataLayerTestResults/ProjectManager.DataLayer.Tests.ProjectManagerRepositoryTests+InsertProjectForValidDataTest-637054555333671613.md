# ProjectManager.DataLayer.Tests.ProjectManagerRepositoryTests+InsertProjectForValidDataTest
...
```
NBench.NBenchException: Error occurred during $ProjectManager.DataLayer.Tests.ProjectManagerRepositoryTests+InsertProjectForValidDataTest RUN. ---> NUnit.Framework.AssertionException: Multiple failures or warnings in test:
  1)   Expected: True
  But was:  False
  ...
  But was:  False
   ...
   at ProjectManager.DataLayer.Tests.ProjectManagerRepositoryTests.InsertProjectForValidDataTest() in C:\Reshma\FinalCertification\LatestFSEFinals\ProjectManagerWebAPI\ProjectManager.DataLayer.Tests\ProjectManagerRepositoryTests.cs:line 127
