# ProjectManager.DataLayer.Tests.ProjectManagerRepositoryTests+InsertTaskForValidDataTest
_9/30/2019 3:50:39 PM_
### System Info
```ini
...
```
NBench.NBenchException: Error occurred during $ProjectManager.DataLayer.Tests.ProjectManagerRepositoryTests+InsertTaskForValidDataTest RUN. ---> NUnit.Framework.AssertionException:   Expected: True
  But was:  False
   ...
   at ProjectManager.DataLayer.Tests.ProjectManagerRepositoryTests.InsertTaskForValidDataTest() in C:\Reshma\FinalCertification\LatestFSEFinals\ProjectManagerWebAPI\ProjectManager.DataLayer.Tests\ProjectManagerRepositoryTests.cs:line 28
