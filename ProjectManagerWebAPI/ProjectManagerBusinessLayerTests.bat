...
SET DllContainingTests=%~dp0ProjectManager.BusinessLayer.Tests\bin\Debug\ProjectManager.BusinessLayer.Tests.dll
...
"%OpenCoverExe%" ^
 ...
 -filter:"+[ProjectManager.BusinessLayer*]* -[*.Tests*]* -[*]*.*Config" ^
 -mergebyhash ^
 -skipautoprops ^
 -register:user ^
 -output:"%~dp0GeneratedReports\CoverageReport_BusinessLayer.xml"
exit /b %errorlevel%

:RunReportGeneratorOutput
"%ReportGeneratorExe%" ^
 -reports:"%~dp0\GeneratedReports\CoverageReport_BusinessLayer.xml" ^
 -targetdir:"%~dp0\GeneratedReports\ReportGenerator Output Business"
exit /b %errorlevel%
