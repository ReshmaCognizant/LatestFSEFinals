...
SET DllContainingTests=%~dp0ProjectManager.DataLayer.Tests\bin\Debug\ProjectManager.DataLayer.Tests.dll
...
"%OpenCoverExe%" ^
 ...
 -filter:"+[ProjectManager.DataLayer*]* -[*.Tests*]* -[*]*.*Config" ^
 -mergebyhash ^
 -skipautoprops ^
 -register:user ^
 -output:"%~dp0GeneratedReports\CoverageReport_DataLayer.xml"
exit /b %errorlevel%
